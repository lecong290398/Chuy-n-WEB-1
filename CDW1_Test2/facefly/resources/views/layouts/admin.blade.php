...
<footer>
    ...
    <script type="text/javascript" src="{{ asset('admin/vendor/morrisjs/morris.min.js')}}"></script>
    <script type="text/javascript" src="{{ asset('admin/data/morris-data.js')}}"></script>
